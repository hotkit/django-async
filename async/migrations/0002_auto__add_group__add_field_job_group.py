...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('async_job', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='jobs', null=True, blank=True, to=orm['async.Group']),
                      keep_default=False)
    ...
    models = {
        ...
        'async.job': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'jobs'", 'null': 'True', 'blank': 'True', 'to': "orm['async.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
